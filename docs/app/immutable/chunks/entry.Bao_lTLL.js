...
window.fetch = (e, n) => (
  (e instanceof Request
    ? e.method
    : (n == null ? void 0 : n.method) || "GET") !== "GET" && B.delete(ge(e)),
  $e(e, n)
);
const B = new Map();
function wt(e, n) {
...
var je;
const L =
  ((je = globalThis.__sveltekit_1dpvcgv) == null ? void 0 : je.base) ?? "";
var De;
const It =
    ((De = globalThis.__sveltekit_1dpvcgv) == null ? void 0 : De.assets) ?? L,
  Tt = "1740068935999",
...
async function an(e, n, t) {
  ...
  (document.URL !== location.href && (location.href = location.href),
    ...
    E ||
      ((E = T = Date.now()),
      history.replaceState({ ...history.state, [j]: E, [q]: T }, "")));
  const r = C[E];
...
function Xe(e) {
  Z.some((n) => (n == null ? void 0 : n.snapshot)) &&
    (M[e] = Z.map((n) => {
      var t;
      return (t = n == null ? void 0 : n.snapshot) == null
        ? void 0
        : t.capture();
    }));
}
...
async function fe(e) {
  ...
  n &&
    (await Promise.all(
      [...n.layouts, n.leaf].map((t) => (t == null ? void 0 : t[1]())),
    ));
}
function et(e, n, t) {
  var o;
...
function te({
  ...
  if (L && (e.pathname === L || e.pathname === L + "/")) s = "always";
    ...
    for (const u of t)
      (u == null ? void 0 : u.slash) !== void 0 && (s = u.slash);
  ...
  for (let u = 0; u < Math.max(t.length, _.branch.length); u += 1) {
    ...
    ((m == null ? void 0 : m.data) !== (l == null ? void 0 : l.data) &&
      (d = !0),
      m &&
        ((f = { ...f, ...m.data }), d && (c.props[`data_${h}`] = f), (h += 1)));
  }
  return (
    (!_.url ||
      e.href !== _.url.href ||
...
async function oe({ status: e, error: n, url: t, route: r }) {
  ...
  if (F.server_loads[0] === 0)
    try {
      ...
      (t.origin !== K || t.pathname !== location.pathname || we) &&
        (await $(t));
    }
  const s = await Ae({
      loader: de,
...
function Xt() {
  ...
  (U.addEventListener("mousedown", n),
    U.addEventListener("touchstart", n, { passive: !0 }));
  const t = new IntersectionObserver(
    (o) => {
      for (const i of o)
        i.isIntersecting && (fe(i.target.href), t.unobserve(i.target));
    },
    { threshold: 0 },
  );
  function r(o, i) {
        ...
        return (
          ...
          Ae({
            ...
            parent: async () => {
              const y = {};
              for (let b = 0; b < m; b += 1)
                Object.assign(y, (await d[b]).data);
              return y;
            },
