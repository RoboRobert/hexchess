...
export class BoardData {
	...
	public getLayout(layout: LayoutEnum): Layout {
		if (layout == LayoutEnum.FLIPPED) {
			return new Layout(Layout.FLIPPED, new Point(this.hexSize, this.hexSize), new Point(0, 0));
		}

		return new Layout(Layout.FLAT, new Point(this.hexSize, this.hexSize), new Point(0, 0));
	}
}
