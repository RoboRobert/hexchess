<script lang="ts">
	...
	import { boardData, defaultBoard, effectStore, selectedPiece } from '$lib/state/stateStore';
	...
	function updatePos() {
		...
		let targetRect = (
			document.getElementById(`${currentPiece.hex.q},${currentPiece.hex.r}`) as HTMLElement
	...
	function updateState() {
		effectStore.set(new BoardEffects(previousHex, selections, legal, attacks, previous));
	}
</script>
